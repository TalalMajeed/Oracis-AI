        ...
        <section className="py-20 md:py-28">
          <div className="container flex flex-col items-center text-center">
            <div className="inline-flex items-center rounded-full border px-3 py-1 text-sm">
              <span className="mr-1 rounded-full bg-primary px-1.5 py-0.5 text-xs text-white">
                New
              </span>
              <span className="text-muted-foreground">
                AI-powered profile evaluation is now available!
              </span>
            </div>
            ...
            <p className="mt-6 max-w-[42rem] text-muted-foreground md:text-xl">
              Oracis AI uses advanced artificial intelligence to evaluate
              profiles, connect companies and individuals, and secure agreements
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-center text-muted-foreground">
                  Our AI analyzes profiles to find the perfect match between
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-center text-muted-foreground">
                  Smart contracts ensure secure and verifiable NDA signing
                  between parties.
                </p>
              </div>
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-center text-muted-foreground">
                  Get detailed analytics and recommendations to improve your
                  profile or hiring process.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="mx-auto max-w-[58rem] text-center">
              ...
              <p className="mt-4 text-muted-foreground md:text-xl">
                Our platform combines cutting-edge AI with blockchain technology
                to create a secure and efficient ecosystem for professional
                connections.
              </p>
            </div>
            <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    ...
                    tailored to your skills and target industry.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Our AI scrapes and analyzes data from LinkedIn and other
                    profiles to generate detailed evaluations.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Post job openings and contract opportunities with AI-powered
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Get personalized recommendations based on skills,
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Real-time communication between companies and clients for
                    job discussions and negotiations.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
        ...
        <section id="how-it-works" className="py-20">
          <div className="container">
            <div className="mx-auto max-w-[58rem] text-center">
              ...
              <p className="mt-4 text-muted-foreground md:text-xl">
                Our platform streamlines the connection between talent and
                opportunity with a simple process.
              </p>
            </div>
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              <div className="relative flex flex-col items-center">
                ...
                <p className="mt-2 text-center text-muted-foreground">
                  Sign up and build your profile or upload your existing CV. Our
                  AI will analyze and enhance it.
                </p>
              ...
              <div className="relative flex flex-col items-center">
                ...
                <p className="mt-2 text-center text-muted-foreground">
                  Receive personalized job or candidate recommendations based on
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="mt-2 text-center text-muted-foreground">
                  Connect with matches, sign NDAs with blockchain security, and
        ...
        <section id="testimonials" className="bg-slate-50 py-20">
          <div className="container">
            <div className="mx-auto max-w-[58rem] text-center">
              ...
              <p className="mt-4 text-muted-foreground md:text-xl">
                Hear from candidates and employers who have found success with
                Oracis AI.
              </p>
            </div>
            <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "The AI recommendations were spot on! I found a job that
                    perfectly matched my skills and preferences within a week of
                    signing up."
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "Oracis AI has revolutionized our hiring process. The
                    quality of candidates we've found through the platform is
                    exceptional."
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "The AI-powered CV builder helped me highlight my strengths
                    in ways I hadn't considered. I'm now working at my dream
                    company!"
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="bg-primary py-20 text-white">
          <div className="container text-center">
            ...
            <p className="mx-auto mt-4 max-w-[42rem] text-primary-foreground/90 md:text-xl">
              Join thousands of professionals and companies already using Oracis
              AI to connect.
            </p>
