          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={company.notifications.applications}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get notified about interview changes
                  </p>
                </div>
                <Switch
                  defaultChecked={company.notifications.interviews}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={company.notifications.messages}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={company.notifications.contracts}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  defaultChecked={company.notifications.system}
                />
              </div>
            </CardContent>
          </Card>
